...
function submitForm(){
    ...
    if (getLocale() == 'ua'){
        ...
        var birthDate= 'Не валідний формта. Приклад: 1993-07-21';
        var gender= 'Не валідний формта. Має бути MALE або FEMALE';
        var firstName = 'Не валідний формта. Приклад: Solomon';
        var lastName = 'Не валідний формта. Приклад: Kane';
    }else{
